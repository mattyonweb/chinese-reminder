...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.spinBoxLvl.setGeometry(QtCore.QRect(490, 80, 42, 27))
        self.spinBoxLvl.setObjectName("spinBoxLvl")
        self.label = QtWidgets.QLabel(self.centralwidget)
        self.label.setGeometry(QtCore.QRect(490, 60, 41, 18))
        self.label.setObjectName("label")
        self.comboBoxLvl = QtWidgets.QComboBox(self.centralwidget)
        self.comboBoxLvl.setGeometry(QtCore.QRect(440, 80, 41, 26))
