...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.spinBoxLvl.setGeometry(QtCore.QRect(490, 30, 42, 27))
        self.spinBoxLvl.setObjectName("spinBoxLvl")
        self.label = QtWidgets.QLabel(self.centralwidget)
        self.label.setGeometry(QtCore.QRect(440, 10, 41, 18))
        self.label.setObjectName("label")
        self.comboBoxLvl = QtWidgets.QComboBox(self.centralwidget)
        self.comboBoxLvl.setGeometry(QtCore.QRect(440, 30, 41, 26))
        self.comboBoxLvl.setAcceptDrops(True)
        self.comboBoxLvl.setToolTip("")
        self.comboBoxLvl.setEditable(False)
        self.comboBoxLvl.setObjectName("comboBoxLvl")
        self.btnReset = QtWidgets.QPushButton(self.centralwidget)
        self.btnReset.setGeometry(QtCore.QRect(440, 80, 91, 31))
        font = QtGui.QFont()
        font.setBold(False)
        ...
        self.mainMenuBar.setGeometry(QtCore.QRect(0, 0, 537, 23))
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.comboBoxLvl.setPlaceholderText(_translate("MainWindow", "Foovar"))
